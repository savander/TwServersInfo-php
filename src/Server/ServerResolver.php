...
class ServerResolver implements ServerResolverInterface
{
    ...
    * Teeworlds 0.5 UDP DATA
	**/
    const VERSION_05 = 5;

    const VERSION_05_DATA = "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xffgief";

    # Teeworlds 0.6 UDP DATA
    const VERSION_06 = 6;

    const VERSION_06_DATA = "\xff\xff\xff\xff\xff\xff\xff\xff\xff\xffgie3\x00";
    ...
    public function resolveServer(
        ...
        $this->parseData($this->getServerData($ipAddress, $port, $data));
    }
